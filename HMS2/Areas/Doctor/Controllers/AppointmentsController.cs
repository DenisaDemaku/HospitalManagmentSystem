...
namespace HMS2.Areas.Doctor.Controllers
{
    [Area("Doctor")]
    ...
    public class AppointmentsController : Controller
    {
        ...
        int? pageNumber)
        {
            ...
            var appointments = from s in _context.Appointments.Include(a => a.Author).Include(a => a.Doctor).Where(a => a.DoctorId == CurrentUserId)
                               select s;
